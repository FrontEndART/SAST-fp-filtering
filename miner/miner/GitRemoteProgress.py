# Solution from here: https://stackoverflow.com/questions/51045540/python-progress-bar-for-git-clone
...
class GitRemoteProgress(git.RemoteProgress):
    ...
    def _dispatch_bar(self, title: str | None = "") -> None:
        ...
        self.alive_bar_instance = alive_bar(manual=True, title=title,bar="classic")
